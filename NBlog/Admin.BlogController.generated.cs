...
namespace NBlog.Areas.Admin.Controllers {
    public partial class BlogController {
        ...
        public class ViewNames {
            public readonly string Create = "~/Areas/Admin/Views/Blog/Create.cshtml";
        }
    }
    ...
    public class T4MVC_BlogController: NBlog.Areas.Admin.Controllers.BlogController {
        ...
        public override System.Web.Mvc.ActionResult Create(NBlog.Areas.Admin.Models.CreateBlogModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Create);
