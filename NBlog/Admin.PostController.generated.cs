...
namespace NBlog.Areas.Admin.Controllers {
    public partial class PostController {
        ...
        public class ViewNames {
            public readonly string _EditCreatePost = "~/Areas/Admin/Views/Post/_EditCreatePost.cshtml";
    ...
    public class T4MVC_PostController: NBlog.Areas.Admin.Controllers.PostController {
        ...
        public override System.Web.Mvc.ActionResult Create(NBlog.Areas.Admin.Models.PostViewModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Create);
